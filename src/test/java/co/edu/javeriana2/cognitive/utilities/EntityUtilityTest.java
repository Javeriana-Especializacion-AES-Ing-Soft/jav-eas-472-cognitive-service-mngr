...
public class EntityUtilityTest { // NOSONAR

    public static void testEntity(Class<?> classDto) throws InstantiationException, IllegalAccessException, InvocationTargetException, DatatypeConfigurationException {
